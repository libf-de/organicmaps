...
public class MapScreen extends BaseMapScreen
{
  ...
  private Header createHeader()
  {
    ...
    builder.setTitle(getCarContext().getString(app.organicmaps.branding.R.string.app_name));
    return builder.build();
  }
  ...
  private void openBookmarks()
  {
    ...
    if (getScreenManager().getTop() != this)
      return;
    getScreenManager().push(
        new BookmarkCategoriesScreen(getCarContext(), getOrganicMapsContext(), getSurfaceRenderer()));
  }
  ...
  private void openSettings()
  {
    ...
    if (getScreenManager().getTop() != this)
      return;
    getScreenManager().push(new SettingsScreen(getCarContext(), getOrganicMapsContext(), getSurfaceRenderer()));
  }
}
